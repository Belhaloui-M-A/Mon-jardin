...
const FR: Translations = {
  ...
  home_title1: "La nature chez vous,",
  home_title2: "à portée de clic",
  home_sub:
    "Des plantes soigneusement sélectionnées — livrées avec leurs conseils d'entretien personnalisés.",
  home_cta_explore: "Explorer le catalogue",
  home_cta_register: "Créer un compte",
  home_stat_varieties: "Variétés",
  home_stat_categories: "Catégories",
  home_stat_delivery: "Livraison",
  home_stat_satisfaction: "Satisfaction",
  home_scroll: "Défiler pour explorer",
  home_collections: "Collections",
  home_collections_title: "Nos catégories",
  home_collections_sub: "Trouvez la plante parfaite pour chaque espace",
  home_featured_label: "Coup de cœur",
  home_featured_title: "Plante du mois",
  home_catalogue_label: "Catalogue",
  home_catalogue_title: "Nouveautés",
  home_see_all: "Voir tout",
  home_cta_title: "Prêt à verdir votre espace ?",
  home_cta_sub:
    "Créez votre compte gratuitement et profitez de conseils personnalisés.",
  home_cta_btn: "Commencer mes achats",
  home_stock_limited: "Stock limité",

  cat_interior: "Intérieur",
  cat_exterior: "Extérieur",
  cat_succulents: "Succulentes & Cactus",
  cat_aromatic: "Aromatiques",
  cat_tropical: "Tropicales",

  catalogue_label: "Boutique",
  catalogue_title: "Catalogue",
  catalogue_search: "Rechercher une plante, espèce...",
  catalogue_filters: "Filtres",
  catalogue_category: "Catégorie",
  catalogue_all: "Toutes",
  catalogue_max_price: "Prix max",
  catalogue_stock_only: "En stock uniquement",
  catalogue_stock_label: "Stock",
  catalogue_sort_by: "Trier par",
  catalogue_sort_new: "Plus récent",
  catalogue_sort_asc: "Prix croissant",
  catalogue_sort_desc: "Prix décroissant",
  catalogue_sort_az: "Nom A–Z",
  catalogue_reset: "↺ Réinitialiser",
  catalogue_results: "plantes",
  catalogue_plants: "plantes trouvées",
  catalogue_no_result: "Aucune plante trouvée",
  catalogue_no_result_sub: "Essayez de modifier vos filtres",
  catalogue_reset_filters: "Réinitialiser les filtres",
  catalogue_limited: "restants",
  catalogue_rupture: "Rupture",
  catalogue_new: "Nouveau",

  detail_category: "Catégorie",
  detail_in_stock: "✅ En stock",
  detail_low_stock: "⚠️ Stock limité",
  detail_out_stock: "❌ Rupture",
  detail_watering: "Arrosage",
  detail_light: "Lumière",
  detail_add_cart: "Ajouter au panier",
  detail_similar: "Vous aimerez aussi",
  detail_toxic: "⚠️ Toxique animaux",
  detail_size: "Taille",
  ...
  cart_discover: "Découvrir le catalogue",
  cart_unit: "/ unité",
  cart_subtotal: "Sous-total",
  cart_delivery: "Livraison",
  cart_included: "Incluse",
  cart_total: "Total",
  ...
  checkout_label: "Achat",
  checkout_title: "Finaliser la commande",
  checkout_step1: "Adresse de livraison",
  checkout_address: "Adresse *",
  checkout_city: "Ville / Wilaya *",
  ...
  checkout_step2: "Votre commande",
  checkout_confirm: "Confirmer la commande",
  checkout_back: "← Modifier le panier",
  checkout_delivery_incl: "Livraison incluse",
  checkout_success_title: "Commande confirmée !",
  checkout_success_sub: "Vous serez contacté pour confirmer la livraison.",
  checkout_success_msg: "enregistrée avec succès.",
  checkout_track: "Suivre ma commande",
  checkout_continue: "Continuer mes achats",

  orders_label: "Historique",
  ...
  wishlist_title: "❤️ Mes favoris",
  wishlist_empty: "Aucun favori",
  wishlist_empty_sub: "Cliquez sur ♡ sur une fiche plante pour l'ajouter ici",
  ...
  profile_email: "Email",
  profile_address: "Adresse de livraison",
  profile_save: "Enregistrer",
  profile_my_orders: "Mes commandes",
  profile_my_wishlist: "Mes favoris",
  profile_modify: "Modifier mes informations",
  profile_orders_sub: "Suivi & historique",
  profile_wishlist_sub: "Plantes sauvegardées",

  auth_login_title: "PlantVerde",
  ...
  auth_register_sub: "Rejoignez la communauté PlantVerde",
  ...
  admin_new_plant: "Nouvelle plante",
  admin_revenue: "Chiffre d'affaires total",
  admin_revenue_month: "ce mois",
  admin_pending_orders: "Commandes à traiter",
  admin_to_process: "Prioritaires",
  admin_clients: "Clients inscrits",
  admin_low_stock: "Stock faible",
  admin_low_stock_sub: "Moins de 5 unités",
  admin_sales_chart: "Ventes — 30 derniers jours",
  admin_top_sales: "🏆 Top ventes",
  admin_no_sales: "Aucune vente",
  admin_alerts: "⚠️ Alertes stock faible",
  admin_manage_plants: "Gestion Plantes",
  admin_crud: "CRUD catalogue",
  admin_manage_orders: "Commandes",
  admin_manage_statuses: "Gérer les statuts",
  admin_manage_users: "Utilisateurs",
  admin_manage_accounts: "Gérer les comptes",
  admin_quick_links: "Accès rapide",

  admin_plants_label: "Administration",
  admin_plants_title: "Gestion des plantes",
  admin_plants_count: "plantes au catalogue",
  admin_plant_name: "Nom *",
  admin_plant_species: "Espèce",
  admin_plant_category: "Catégorie *",
  admin_plant_price: "Prix (DA) *",
  admin_plant_stock: "Stock *",
  admin_plant_difficulty: "Difficulté",
  admin_plant_status: "Statut",
  admin_plant_actions: "Actions",
  admin_plant_active: "Actif",
  admin_plant_inactive: "Inactif",
  admin_plant_new: "Nouvelle plante",
  admin_plant_edit: "Modifier la plante",
  admin_plant_delete_confirm: "Supprimer cette plante ?",
  admin_plant_watering: "Arrosage",
  admin_plant_light: "Lumière",
  admin_plant_size: "Taille adulte",
  admin_plant_discount: "Remise (%)",
  admin_plant_description: "Description",
  admin_plant_image_url: "URL Image",
  admin_cancel: "Annuler",
  admin_create: "Créer",
  admin_edit_btn: "Modifier",

  admin_orders_label: "Administration",
  ...
  admin_orders_change: "Changer statut",
  admin_orders_items: "Articles",
  admin_orders_delivery: "Livraison",
  admin_orders_confirm_btn: "Confirmer",
  admin_orders_ship_btn: "Expédier",
  admin_orders_deliver_btn: "Marquer livré",
  admin_orders_cancel_btn: "Annuler",
  admin_orders_none: "Aucune commande",

  admin_users_label: "Administration",
  admin_users_title: "Gestion des utilisateurs",
  admin_users_count: "comptes enregistrés",
  admin_users_user: "Utilisateur",
  admin_users_email: "Email",
  admin_users_phone: "Téléphone",
  admin_users_role: "Rôle",
  admin_users_status: "Statut",
  admin_users_joined: "Inscription",
  admin_users_actions: "Actions",
  admin_users_active: "Actif",
  admin_users_disabled: "Désactivé",
  admin_users_protected: "Protégé",
  admin_users_none: "Aucun utilisateur",
  admin_users_create: "Créer un compte",
  admin_users_create_title: "Nouvel utilisateur",
  admin_users_role_admin: "Administrateur",
  admin_users_role_client: "Client",

  review_title: "Évaluations clients",
  review_sub: "Ce que pensent nos clients",
  review_write: "Évaluer le service",
  review_edit: "Modifier mon avis",
  review_your_rating: "Votre note",
  review_service: "Service client",
  review_delivery: "Livraison",
  review_quality: "Qualité des plantes",
  review_overall: "Impression générale",
  ...
  review_based_on: "Basé sur",
  review_ratings: "avis",
  review_no_reviews: "Aucun avis pour l'instant",
  review_verified: "Achat vérifié",
  review_label: "⭐ Avis",
  review_avg: "Note moyenne",
  review_rating_1: "Très mauvais",
  review_rating_2: "Mauvais",
  review_rating_3: "Correct",
  review_rating_4: "Bien",
  review_rating_5: "Excellent",
  review_select_rating: "Sélectionnez une note",
  ...
  footer_delivery: "🌍 Algérie",
  footer_payment: "✅ Paiement livraison",
...
const AR: Translations = {
  ...
  home_title1: "الطبيعة في منزلك،",
  home_title2: "بنقرة واحدة",
  home_sub: "نباتات مختارة بعناية — تُسلَّم مع نصائح العناية الشخصية.",
  home_cta_explore: "استكشاف المتجر",
  home_cta_register: "إنشاء حساب",
  home_stat_varieties: "صنف",
  home_stat_categories: "فئات",
  home_stat_delivery: "توصيل",
  home_stat_satisfaction: "رضا",
  home_scroll: "اسحب للاستكشاف",
  home_collections: "المجموعات",
  home_collections_title: "فئاتنا",
  home_collections_sub: "ابحث عن النبات المثالي لكل مكان",
  home_featured_label: "مميز",
  home_featured_title: "نبات الشهر",
  home_catalogue_label: "المتجر",
  home_catalogue_title: "وصل حديثًا",
  ...
  cat_interior: "نباتات داخلية",
  cat_exterior: "نباتات خارجية",
  cat_succulents: "نباتات صحراوية",
  cat_aromatic: "نباتات عطرية",
  cat_tropical: "نباتات استوائية",

  catalogue_label: "المتجر",
  catalogue_title: "الكتالوج",
  catalogue_search: "ابحث عن نبات أو نوع...",
  catalogue_filters: "الفلاتر",
  catalogue_category: "الفئة",
  catalogue_all: "الكل",
  catalogue_max_price: "الحد الأقصى للسعر",
  catalogue_stock_only: "المتوفر فقط",
  catalogue_stock_label: "المخزون",
  catalogue_sort_by: "ترتيب حسب",
  catalogue_sort_new: "الأحدث",
  catalogue_sort_asc: "السعر من الأقل",
  catalogue_sort_desc: "السعر من الأكثر",
  catalogue_sort_az: "الاسم أ–ي",
  catalogue_reset: "↺ إعادة تعيين",
  catalogue_results: "نبات",
  catalogue_plants: "نبات موجود",
  catalogue_no_result: "لا توجد نباتات",
  catalogue_no_result_sub: "حاول تعديل الفلاتر",
  catalogue_reset_filters: "إعادة تعيين الفلاتر",
  catalogue_limited: "متبقٍ",
  catalogue_rupture: "نفد المخزون",
  catalogue_new: "جديد",

  detail_category: "الفئة",
  detail_in_stock: "✅ متوفر",
  detail_low_stock: "⚠️ مخزون محدود",
  detail_out_stock: "❌ نفد المخزون",
  detail_watering: "الري",
  detail_light: "الضوء",
  detail_add_cart: "أضف إلى السلة",
  detail_similar: "قد يعجبك أيضًا",
  detail_toxic: "⚠️ سام للحيوانات",
  detail_size: "الحجم",
  ...
  checkout_step1: "عنوان التوصيل",
  checkout_address: "العنوان *",
  checkout_city: "المدينة / الولاية *",
  ...
  checkout_back: "تعديل السلة ←",
  checkout_delivery_incl: "توصيل مجاني",
  checkout_success_title: "تم تأكيد الطلب!",
  checkout_success_sub: "سيتم التواصل معك لتأكيد التوصيل.",
  checkout_success_msg: "تم بنجاح.",
  checkout_track: "تتبع طلبي",
  ...
  orders_empty_sub: "لم تقم بأي طلب بعد",
  orders_cancel: "إلغاء",
  orders_address: "العنوان",
  orders_status_pending: "قيد الانتظار",
  orders_status_confirmed: "تم التأكيد",
  orders_status_shipped: "تم الشحن",
  orders_status_delivered: "تم التسليم",
  orders_status_cancelled: "ملغي",

  wishlist_label: "المفضلة",
  wishlist_title: "❤️ قائمة المفضلة",
  wishlist_empty: "لا توجد مفضلات",
  wishlist_empty_sub: "انقر على ♡ في صفحة النبات لإضافته هنا",
  ...
  profile_my_wishlist: "مفضلتي",
  profile_modify: "تعديل معلوماتي",
  profile_orders_sub: "التتبع والسجل",
  profile_wishlist_sub: "النباتات المحفوظة",

  auth_login_title: "PlantVerde",
  auth_login_sub: "سجّل دخولك إلى حسابك",
  ...
  auth_register_sub: "انضم إلى مجتمع PlantVerde",
  ...
  admin_new_plant: "نبات جديد",
  admin_revenue: "إجمالي الإيرادات",
  admin_revenue_month: "هذا الشهر",
  admin_pending_orders: "الطلبات المعلقة",
  admin_to_process: "ذات أولوية",
  admin_clients: "العملاء المسجلون",
  admin_low_stock: "مخزون منخفض",
  admin_low_stock_sub: "أقل من 5 وحدات",
  admin_sales_chart: "المبيعات — آخر 30 يومًا",
  admin_top_sales: "🏆 الأكثر مبيعًا",
  admin_no_sales: "لا مبيعات",
  admin_alerts: "⚠️ تنبيهات المخزون المنخفض",
  admin_manage_plants: "إدارة النباتات",
  admin_crud: "إضافة/تعديل/حذف",
  admin_manage_orders: "الطلبات",
  admin_manage_statuses: "إدارة الحالات",
  admin_manage_users: "المستخدمون",
  admin_manage_accounts: "إدارة الحسابات",
  admin_quick_links: "وصول سريع",

  admin_plants_label: "الإدارة",
  admin_plants_title: "إدارة النباتات",
  admin_plants_count: "نبات في الكتالوج",
  admin_plant_name: "الاسم *",
  admin_plant_species: "النوع",
  admin_plant_category: "الفئة *",
  admin_plant_price: "السعر (دج) *",
  admin_plant_stock: "المخزون *",
  admin_plant_difficulty: "الصعوبة",
  admin_plant_status: "الحالة",
  admin_plant_actions: "الإجراءات",
  admin_plant_active: "نشط",
  admin_plant_inactive: "غير نشط",
  admin_plant_new: "نبات جديد",
  admin_plant_edit: "تعديل النبات",
  admin_plant_delete_confirm: "حذف هذا النبات؟",
  admin_plant_watering: "الري",
  admin_plant_light: "الضوء",
  admin_plant_size: "الحجم البالغ",
  admin_plant_discount: "الخصم (%)",
  admin_plant_description: "الوصف",
  admin_plant_image_url: "رابط الصورة",
  admin_cancel: "إلغاء",
  admin_create: "إنشاء",
  admin_edit_btn: "تحديث",

  admin_orders_label: "الإدارة",
  admin_orders_title: "إدارة الطلبات",
  admin_orders_id: "#",
  admin_orders_client: "العميل",
  admin_orders_date: "التاريخ",
  admin_orders_total: "الإجمالي",
  admin_orders_status: "الحالة",
  admin_orders_change: "تغيير الحالة",
  admin_orders_items: "المنتجات",
  admin_orders_delivery: "التوصيل",
  admin_orders_confirm_btn: "تأكيد",
  admin_orders_ship_btn: "شحن",
  admin_orders_deliver_btn: "تسليم",
  admin_orders_cancel_btn: "إلغاء",
  admin_orders_none: "لا توجد طلبات",

  admin_users_label: "الإدارة",
  admin_users_title: "إدارة المستخدمين",
  admin_users_count: "حساب مسجل",
  admin_users_user: "المستخدم",
  ...
  admin_users_actions: "الإجراءات",
  admin_users_active: "نشط",
  admin_users_disabled: "معطّل",
  admin_users_protected: "محمي",
  admin_users_none: "لا مستخدمين",
  admin_users_create: "إنشاء حساب",
  admin_users_create_title: "مستخدم جديد",
  admin_users_role_admin: "مدير",
  admin_users_role_client: "عميل",

  review_title: "تقييمات العملاء",
  review_sub: "ماذا يقول عملاؤنا",
  review_write: "تقييم الخدمة",
  review_edit: "تعديل تقييمي",
  review_your_rating: "تقييمك",
  review_service: "خدمة العملاء",
  review_delivery: "التوصيل",
  review_quality: "جودة النباتات",
  review_overall: "الانطباع العام",
  review_comment_ph: "شارك تجربتك...",
  review_submit: "نشر تقييمي",
  review_update: "تحديث",
  review_cancel: "إلغاء",
  review_success: "شكرًا على تقييمك!",
  review_already: "لقد قمت بتقييم هذه الخدمة مسبقًا.",
  review_login_required: "سجّل دخولك للتقييم",
  review_based_on: "بناءً على",
  review_ratings: "تقييم",
  review_no_reviews: "لا توجد تقييمات بعد",
  review_verified: "شراء موثق",
  review_label: "⭐ تقييمات",
  review_avg: "متوسط التقييم",
  review_rating_1: "سيء جداً",
  review_rating_2: "سيء",
  review_rating_3: "مقبول",
  review_rating_4: "جيد",
  review_rating_5: "ممتاز",
  review_select_rating: "اختر تقييماً",
  ...
  footer_delivery: "🌍 الجزائر",
  footer_payment: "✅ الدفع عند الاستلام",
